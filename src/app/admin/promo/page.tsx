  ...
  return (
    <div className="flex gap-2">
      ...
      <TacticalConfirmModal 
        ...
        message={isRefundMode ? `Are you sure you want to completely refund the ${promo.participants?.length} participants ${promo.entryFeeCoins} coins each and delete this promo?` : `Are you sure you want to expunge the 100K RUSH: ${promo.game}? This data cannot be recovered once purged from the neural core.`}
