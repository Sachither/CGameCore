...
import { getDisputedMatchesAction, resolveDisputeAction, cancelStaleMatchAction, triggerAdminInterventionAction } from "@/app/actions/admin-actions";
import { Gavel, ImageIcon, AlertTriangle, CheckCircle2, XCircle, RotateCcw, Loader2, MessageSquare, ExternalLink, ShieldAlert } from "lucide-react";
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="bg-black border border-white/10 rounded-sm overflow-hidden aspect-video relative group">
                           {selected.disputeImageProof ? (
                             <>
                               <img src={selected.disputeImageProof} alt="Dispute Proof" className="w-full h-full object-cover" />
                ...
                {playerList.map((p: any) => (
                  <div key={p.uid} className="p-5">
                    <div className="mb-3">
                      ...
                      <span className={`text-[8px] font-black uppercase tracking-widest px-2 py-0.5 rounded-sm border mt-1 inline-block ${p.claim === "WIN" ? "bg-green-500/10 text-green-400 border-green-500/20" : "bg-red-500/10 text-red-400 border-red-500/20"}`}>
