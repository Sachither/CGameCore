            ...
            <div className="flex items-center gap-4">
              {activeMatch && (
                ...
                >
                  ...
                  <span className="text-[9px] font-black uppercase text-accent-aware tracking-widest">Live Match</span>
                </div>
              )}
            ...
            <div className="flex items-center gap-6">
               {activeMatch && (
                 <Link href={`/match/${activeMatch.id}`} className="bg-accent-aware/10 border border-accent/20 px-4 py-2 rounded-sm flex items-center gap-3 group cursor-pointer hover:bg-accent-aware/20 hover:border-accent/40 transition-all">
                    ...
                    <span className="text-[10px] font-black uppercase text-accent-aware tracking-[0.2em]">Resume Match</span>
                 </Link>
               )}
