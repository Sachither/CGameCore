...
import { getUserNotificationsAction, markNotificationReadAction, markAllNotificationsReadAction } from "@/app/actions/notification-actions";
...
export default function NotificationTray() {
  ...
  const fetchNotes = useCallback(async () => {
    ...
    const res = await getUserNotificationsAction(idToken);
