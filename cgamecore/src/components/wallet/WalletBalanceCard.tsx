  ...
  return (
    <div className="bg-surface border border-surface-border rounded-[5px] p-6 lg:p-10 shadow-2xl relative overflow-hidden group">
      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center">
        <div>
          <h2 className="text-sub text-xs font-bold uppercase tracking-widest mb-2 flex items-center justify-between gap-2 overflow-hidden">
          ...
          <p className="text-sub text-sm mt-2 font-mono bg-black/50 inline-block px-3 py-1 rounded-[3px] border border-surface-border">
             Asset Value ≈ ₦{(balance * 15).toLocaleString()}
          </p>
        </div>
